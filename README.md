...
> outline buttons that flood yellow on hover, product names uppercase.v4.0 — synced with the live build at orphan-wear.higgsfield.app (2026-09-13). Re-import/re-sync your tool to pick up this version.
